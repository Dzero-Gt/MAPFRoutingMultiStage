...
// Pseudo-cardinal conflicts are semi-/non-caridnal conflicts between dependent
// agents. We prioritize them over normal semi-/non-caridnal conflicts
...
class Conflict {
 public:
  ...
  double secondary_priority =
      0;  // used as the tie-breaking creteria for conflict selection
